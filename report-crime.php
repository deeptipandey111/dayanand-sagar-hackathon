...
<h2> Here you can report any crimes that you witnessed/suffered from ANONYMOUSLY</h2>
        ...
        <div class="col-sm-8 blog-main">
          ...
          <div class="row">
             ...
             <div id="map"></div>
               ...
               <form method="post" id="geocoding_form_issue" action='/insertreport.php'><br><br><br>
                 <label for="address">Description:</label>
                 <div class="input">
                   <textarea id="crimeDescription"rows="1" name='reporttext' cols="110">
                  </textarea><br><br>
